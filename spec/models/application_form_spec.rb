...
describe ApplicationForm do
  ...
  describe "#submit" do
    ...
    context "when fields are too long" do
      ...
      it "sets some good errors on the form" do
        subject
        expect(form.errors.full_messages).to include "Answer to 'Is there an aspect of your background or identity that you think would make AndConf more diverse?' must be 1,000 characters or less"
      end
    end
  end
